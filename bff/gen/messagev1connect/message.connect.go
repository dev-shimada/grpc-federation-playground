...
import (
	...
	context "context"
	errors "errors"
	v1 "github.com/dev-shimada/grpc-federation-playground/message/gen/message/v1"
	http "net/http"
	strings "strings"
)
...
func NewMessageServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) MessageServiceClient {
	...
	messageServiceMethods := v1.File_message_proto.Services().ByName("MessageService").Methods()
