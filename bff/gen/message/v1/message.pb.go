...
const file_message_v1_message_proto_rawDesc = "" +
	...
	"\bPingPong\x12\x1b.message.v1.PingPongRequest\x1a\x1c.message.v1.PingPongResponseB\xb7\x01\n" +
	"\x0ecom.message.v1B\fMessageProtoP\x01ZNgithub.com/dev-shimada/grpc-federation-playground/bff/gen/message/v1;messagev1\xa2\x02\x03MXX\xaa\x02\n" +
	"Message.V1\xca\x02\n" +
